...
# Insert a dropout layer before the last fc layer
...
layer_fc2 = new_fc_layer(input = dropout,
                         num_inputs = fc_size,
...
def optimize(epochs):
    ...
    for i in range(0, epochs):
        ...
        feed_dict_train = {x: x_batch,
                           y_true: y_true_batch,
                           keep_prob: 0.5}  # set dropout prob to 0.5 to start out
...
def print_test_accuracy():
    ...
    while i < num_test:
        ...
        feed_dict = {x: images,
                     y_true: labels,
                     keep_prob: 1}  # remember, set dropout prob to 1 for testing!!
